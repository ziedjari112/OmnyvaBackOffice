...
export class Users {
  ...
  readonly newRoleEntrepriseId = signal<number | null>(null);
  ...
  openEdit(user: UserDto): void {
    ...
    this.newRoleEntrepriseId.set(null);
    this.error.set(null);
    this.showForm.set(true);
  }
  ...
  addRole(): void {
    ...
    this.userService.assignRole(user.id, { roleId, entrepriseId: this.newRoleEntrepriseId() }).subscribe((updated) => {
